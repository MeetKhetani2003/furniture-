    ...
    <div className="mx-auto max-w-[1000px] px-4 py-8">
      ...
      <div className="rounded-3xl border border-gray-100 bg-white p-6 md:p-10 shadow-sm">
        <div className="mb-8 flex items-center gap-3 border-b border-gray-100 pb-6">
          ...
          <div>
            <h1 className="text-[22px] font-semibold text-gray-900 font-[family-name:var(--font-playfair)]">Edit Product</h1>
            <p className="text-[14px] text-gray-500">Update product details and variants.</p>
          </div>
        </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input type="color" value={variant.color_hex || '#000000'} onChange={e => updateVariant(index, "color_hex", e.target.value)} className="w-10 h-10 rounded cursor-pointer" />
                        <input type="text" value={variant.color_hex || '#000000'} onChange={e => updateVariant(index, "color_hex", e.target.value)} className="w-full px-3 py-2 text-sm border rounded-lg focus:ring-1 focus:ring-brand-primary" />
                      </div>
                    </div>
                    <div>
