...
export default function EditAttributeSetPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold font-[family-name:var(--font-playfair)]">Edit Attribute Set</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-4">
          ...
          <div className="space-y-4">
            {attributes.length === 0 && <p className="text-gray-500 text-sm">No attributes in this set.</p>}
