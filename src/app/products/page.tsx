...
// Remove static products import, we will fetch from DB
import { Product } from "@/lib/data/products"; // Just for type definition
          ...
          <div className="flex-1">
            ...
            {loading ? (
              <div className="text-center py-20">
                <p className="text-brand-muted text-lg">Loading amazing products...</p>
              </div>
